...
//private String[]data={"Apple","Banana","Orange","Watermelon","Pear","Grape",
 //       "Pineaple","Strawberry","Chery","Mango","A","B","C","D","E","F","G","H"};
private List<Fruit> fruitList=new ArrayList<Fruit>();
       ...
       initFruits();//初始化水果数据
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivity.this,fruit.getNmae(),Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initFruits(){
        ...
        Fruit pinapple=new Fruit("pinapple",R.drawable.pinapple_pic);  fruitList.add(pinapple);
